...
namespace Problème_scientifique___Image
{
    class Buddhabrot
    {
        ...
        public Buddhabrot(int taille, int iteration, long hitsMax)
        {
            if (taille <= 0)
            {
        ...
        public Buddhabrot(int taille, int iteration, long hitsMax, int IterationRed, int IterationGreen, int IterationBlue)
        {
            if (taille <= 0)
            {
                throw new ArgumentException("Taille doit être plus grand que 0");

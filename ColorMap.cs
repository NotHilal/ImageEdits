...
namespace Problème_scientifique___Image
{
    class ColorMap
    {
        ...
        {
            this.colormapLength = colorLength;
        }
        ...
        #region Méthodes
        public int[,] Spring() //Spring faire combinaison 1-1-3 R-R-B
        {
        ...
        public int[,] Summer() //Summer faire 1-1-3
        {
            int[,] cmap = new int[colormapLength, 4];
        ...
        public int[,] Autumn() //Autumn 3-2-2
        {
            int[,] cmap = new int[colormapLength, 4];
        ...
        public int[,] Jet() //On garde, combinaison classique & 2-3-3 & 1-1-2
        {
            int[,] cmap = new int[colormapLength, 4];
        ...
        public int[,] Hot()
        {
            ...
            return cmap;
        } //On garde, 2-2-1 & 2-2-3 & 1-2-2 & 3-2-3 & 2-1-2
        public int[,] Cool()
        {
            int[,] cmap = new int[colormapLength, 4];
